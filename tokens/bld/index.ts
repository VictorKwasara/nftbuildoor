...
const TOKEN_NAME = "Zimbo Bird";
const TOKEN_SYMBOL = "Zeee";
const TOKEN_DESCRIPTION = "A token for the Zimbabwe bird gang";
const TOKEN_IMAGE_NAME = "zeee.png";
const TOKEN_IMAGE_PATH = `tokens/bld/assets/${TOKEN_IMAGE_NAME}`;


async function createSeeToken(
...
async function main() {
  ...
  // await createSeeToken(connection, payer);
